/**
 *
 * This script defines how rooms manage their terminal, storage, and market.
 *
 * TODO -- in another part of the code, need to set up better queuing system for mineral transport requests.
 *
 * Order of operations:
 * 1) Send to nearby rooms requesting resources.
 * 2) If Storage is almost full, sell extra energy if the storage is <40% energy, otherwise sell extra anything.
 * 3) Until lab code works, sell all extra minerals.
 *
 **/
